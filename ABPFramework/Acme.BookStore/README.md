...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p fb5f3467-d0a8-4d8b-9fbd-b98967171bd9
```

> `fb5f3467-d0a8-4d8b-9fbd-b98967171bd9` is the password of the certificate, you can change it to any password you want.
